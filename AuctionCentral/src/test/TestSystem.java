...
public class TestSystem implements Observer {
   ...
   */
  public TestSystem() throws IOException {
    ...
    for (int i = 0; i < 15; i++) {
      ...
      final Auction demo_auction = new Auction("auction name" + i, "first name" + i + " " + "last name" + i,
    ...
    my_current_user = new NonProfitUser("new username", "new password", "new first name",
        "new last name", "new non-profit");
    //for demo and test
    //************************************
