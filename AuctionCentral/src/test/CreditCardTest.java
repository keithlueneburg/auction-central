...
public class CreditCardTest {
	...
	static CreditCard card_1;
	
	static CreditCard card_1_duplicate;
	...
	public void testEqualsObject() {
		...
		assertFalse(card_1.equals(null));
		...
		assertFalse(card_1.equals(new CreditCard(4567123412341234L, 
				new Date(2015, 1, 15), 123, "John Smith", new Address(),
				new Bank())));
		
		// Different expiration date:
		assertFalse(card_1.equals(new CreditCard(1234123412341234L, 
				new Date(2238, 1, 15), 123, "John Smith", new Address(),
				new Bank())));
		
		// Different CSC
		assertFalse(card_1.equals(new CreditCard(1234123412341234L, 
				new Date(2015, 1, 15), 456, "John Smith", new Address(),
				new Bank())));
		
		// Different CSC
		assertFalse(card_1.equals(new CreditCard(1234123412341234L, 
				new Date(2015, 1, 15), 123, "Dave Jones", new Address(),
				new Bank())));
